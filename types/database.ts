...
export type Database = {
  public: {
    Tables: {
      ...
      products: {
        Row: { id: string; category_id: string | null; name: string; slug: string; brand: string | null; model: string | null; description: string | null; short_description: string | null; image_url: string | null; price_day: number | null; price_week: number | null; price_month: number | null; deposit_amount: number; minimum_rental_days: number; published: boolean; seo_title: string | null; seo_description: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; category_id?: string | null; name: string; slug: string; brand?: string | null; model?: string | null; description?: string | null; short_description?: string | null; image_url?: string | null; price_day?: number | null; price_week?: number | null; price_month?: number | null; deposit_amount?: number; minimum_rental_days?: number; published?: boolean; seo_title?: string | null; seo_description?: string | null }
        Update: { category_id?: string | null; name?: string; slug?: string; brand?: string | null; model?: string | null; description?: string | null; short_description?: string | null; image_url?: string | null; price_day?: number | null; price_week?: number | null; price_month?: number | null; deposit_amount?: number; minimum_rental_days?: number; published?: boolean; seo_title?: string | null; seo_description?: string | null; updated_at?: string }
        Relationships: R[]
      }
      product_locations: {
