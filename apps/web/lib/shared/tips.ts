...
export const TIPS: Tip[] = [
  ...
  },
  {
    ...
    body: 'For at et velferdstiltak skal være skattefritt, må det som hovedregel tilbys alle ansatte eller en naturlig avgrenset gruppe (f.eks. en hel avdeling). Saklige avgrensninger og utilsiktede feil vurderes konkret av Skatteetaten. Dokumenter hvem tilbudet ble gitt til og begrunnelsen for eventuelle avgrensninger — det er det sterkeste vernet ved kontroll.',
    body_enkel: 'Alle ansatte bør inviteres til julebordet. Inviterer du bare noen utvalgte uten saklig grunn, risikerer du at de som var med må betale skatt av fordelen. Løsning: send invitasjon til alle og lagre dokumentasjonen.',
    category: 'velferd',
...

  {
    ...
    body_enkel: 'Tar du med en kunde på mat, kan selskapet trekke fra kostnaden — men bare hvis regningen er under 592 kr per person (2026). Er den over, mister du hele fradraget, ikke bare det overskytende. Husk å notere hvem som var med og hva dere møttes for.',
  ...
  },
  {
    ...
    body_enkel: 'Bestiller noen sprit (whisky, akevitt, vodka o.l.) på kundemiddagen, mister selskapet fradraget på HELE regningen — ikke bare spritglasset. Øl og vin er OK, men husk at alle de andre kravene (riktig tidspunkt, sted og formål) også må være oppfylt.',
    category: 'representasjon',
  ...
  },
  {
    ...
    category: 'lønn-utbytte',
    tags: ['sykepenger', 'pensjon', 'lønn', 'NAV', 'trygd'],
    type: 'planning',
  ...
  },
  {
    ...
    category: 'bil',
    tags: ['firmabil', 'elbil', 'sjablong', '2026'],
    type: 'gotcha',
    tool_href: '/car',
  },
  {
  ...
  },
  {
    ...
    body_enkel: 'Trenger du å ta ut penger kortvarig fra AS-et? Det finnes ett lovlig unntak: låneopptak under 100 000 kr samlet og tilbakebetaling innen 60 dager beskattes normalt ikke som utbytte. Overstiger saldoen 100 000 kr risikerer du utbyttebeskatning av hele beløpet.',
    category: 'aksjonærlån',
    tags: ['aksjonærlån', 'mellomregning', '100000-kr', '60-dager', 'unntak'],
    type: 'saving',
    impact: 'Kortvarig trekk under 100 000 kr: ikke utbyttebeskatning',
    law_ref: 'Skatteloven § 10-11 (4), jf. unntak for kortvarige lån',
  },
